...
#endif  // VL_DEBUG
VL_ATTR_COLD void Vup_counter_tb___024root___eval_stl(Vup_counter_tb___024root* vlSelf);
...
VL_ATTR_COLD void Vup_counter_tb___024root___eval_settle(Vup_counter_tb___024root* vlSelf) {
    ...
    while (__VstlContinue) {
        __VstlContinue = 0U;
        Vup_counter_tb___024root___eval_triggers__stl(vlSelf);
...
#endif
                VL_FATAL_MT("up_counter_tb.v", 1, "", "Settle region did not converge.");
            }
            vlSelf->__VstlIterCount = ((IData)(1U) 
                                       + vlSelf->__VstlIterCount);
            Vup_counter_tb___024root___eval_stl(vlSelf);
        }
    }
}
...
VL_ATTR_COLD void Vup_counter_tb___024root___dump_triggers__stl(Vup_counter_tb___024root* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vup_counter_tb__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vup_counter_tb___024root___dump_triggers__stl\n"); );
    // Body
...
VL_ATTR_COLD void Vup_counter_tb___024root___eval_stl(Vup_counter_tb___024root* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vup_counter_tb__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vup_counter_tb___024root___eval_stl\n"); );
    // Body
    if ((1ULL & vlSelf->__VstlTriggered.word(0U))) {
...
VL_ATTR_COLD void Vup_counter_tb___024root___dump_triggers__act(Vup_counter_tb___024root* vlSelf) {
    ...
    if ((1ULL & vlSelf->__VactTriggered.word(0U))) {
        VL_DBG_MSGF("         'act' region trigger index 0 is active: @(posedge up_counter_tb.clk or posedge up_counter_tb.reset)\n");
    }
...
VL_ATTR_COLD void Vup_counter_tb___024root___dump_triggers__nba(Vup_counter_tb___024root* vlSelf) {
    ...
    if ((1ULL & vlSelf->__VnbaTriggered.word(0U))) {
        VL_DBG_MSGF("         'nba' region trigger index 0 is active: @(posedge up_counter_tb.clk or posedge up_counter_tb.reset)\n");
    }
...
VL_ATTR_COLD void Vup_counter_tb___024root___ctor_var_reset(Vup_counter_tb___024root* vlSelf) {
    ...
    // Body
    vlSelf->up_counter_tb__DOT__clk = VL_RAND_RESET_I(1);
    vlSelf->up_counter_tb__DOT__reset = VL_RAND_RESET_I(1);
    vlSelf->up_counter_tb__DOT__count = VL_RAND_RESET_I(4);
    vlSelf->__Vtrigprevexpr___TOP__up_counter_tb__DOT__clk__0 = VL_RAND_RESET_I(1);
    vlSelf->__Vtrigprevexpr___TOP__up_counter_tb__DOT__reset__0 = VL_RAND_RESET_I(1);
}

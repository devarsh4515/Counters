...
VL_ATTR_COLD void Vup_counter_tb___024unit___ctor_var_reset(Vup_counter_tb___024unit* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vup_counter_tb__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+  Vup_counter_tb___024unit___ctor_var_reset\n"); );
    // Body
